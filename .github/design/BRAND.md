...
| `docs/assets/logo.png` | 200×200 served README header image |

The README references `docs/assets/logo.png` (not the master under `.github/`)
...
src.resize((200,200), Image.LANCZOS).save("docs/assets/logo.png", optimize=True)
PY
```
